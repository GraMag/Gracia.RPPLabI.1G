    	...
    	if (thisNode != NULL)
    	{
    		if(index == 0)
    	   	...
    	   	else
    	   	{
    	   		...
    	   		{
    	   			previousNode->pNextNode = thisNode->pNextNode;
    	   		  	this->size--;
    	   		  	free(thisNode);
    	   		  	returnAux = 0;
    	   		}
...
int ll_sortBy2(LinkedList* this, int (*pFunc)(void* ,void*), int (*pFunc2)(void* ,void*), int order)
{
	int returnAux =-1;
	    int length;
	    void* aux;
	    ...
	    if(this != NULL && pFunc != NULL && order >= 0 && order <= 1)
	    {
	       ...
	       for(int i = 0; i < length-1; i++)
	       {
	    	   for(int j = i + 1; j < length; j++)
	    	   {
	    		   ...
	    		   else if (pFunc(ll_get(this, i),ll_get(this,j)) == 0 && (pFunc2(ll_get(this, i),ll_get(this,j)) > 0) && order == 1)
				   {
	    			   aux = ll_get(this, i);
					   ll_set(this, i, ll_get(this, j));
					   ll_set(this, j, aux);
				   }
	    		   else if (pFunc(ll_get(this, i),ll_get(this,j)) == 0 && (pFunc2(ll_get(this, i),ll_get(this,j)) < 0) && order == 0)
				   {
					   aux = ll_get(this, i);
					   ll_set(this, i, ll_get(this, j));
					   ll_set(this, j, aux);
